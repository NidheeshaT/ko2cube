...
"""
FastAPI application for the Ko2cube Env Environment.

This module creates an HTTP server that exposes the Ko2cubeEnvironment
...
def main(host: str = "0.0.0.0", port: int = 8000):
    ...
    This function enables running the server without Docker:
        ...
        python -m ko2cube_env.server.app
    ...
    multiple workers:
        uvicorn ko2cube_env.server.app:app --workers 4
    """
    import uvicorn
...
if __name__ == "__main__":
    ...
    # Comment main() for openev validation
    main(port=args.port)
